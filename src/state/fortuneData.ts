...
// テストプレイ用の一時措置: trueの間は開くたびに結果が変わる（全パターンを確認するため）。
// **2026-07-26に本番設定（false）へ戻した**＝花もおみくじの運勢も**1日1個**に固定される。
// falseだと同じ日は何度開いても同じ結果になる（日課としての「今日の占い」が本来の仕様）
const TEST_RANDOM_FORTUNE = false
