...
const WALK_MASK = [
  ...
  '##############.######.####.###', // r11 工房の入口ポーチ(c21)
  '##############.######.####.###', // r12
  '##.........................###', // r13 横断道路の本体（2026-08-01実機座標で確定: c2-13も道だったため全通し。c3/c7/c11は畑の作業マスを兼ねる）
  '##................########.###', // r14 道の下段（2026-08-01実機座標で確定: c18-25は茂みの草地だったため封鎖。c2-17=道、c26=右の縦道）
  '##.#.....##...#...########.###', // r15 畑下の草原(左)・灯籠まわり（2026-08-01: c5-8の封鎖はいったん実施したが実機確認で歩行可能へ戻した。行の当たり判定はr13/r14側で確定済み）
  '####.....##...#...########.###', // r16
  '#####....##.......########.###', // r17 咲耶(17,6)
  '#####...######.###########.###', // r18
  '##############.###########.###', // r19
